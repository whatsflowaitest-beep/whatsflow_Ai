...
export default function LeadsPage() {
  ...
  function handleUpdateLead(id: string, data: LeadFormData) {
    ...
    if (viewLead?.id === id) {
      const updated = leads.find(l => l.id === id); // This might be stale due to setState, better to derive or wait
      // The hook handles state update, but we want the drawer to react
