...
export function Navbar() {
  ...
  return (
    <header
      className={`fixed top-0 left-0 right-0 z-[100] transition-all duration-500 px-4 sm:px-6 lg:px-8 ${
        scrolled ? "py-4" : "py-6"
      }`}
    >
      <div 
        className={`max-w-7xl mx-auto h-16 rounded-2xl transition-all duration-500 border ${
          scrolled 
